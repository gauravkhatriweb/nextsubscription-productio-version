/**
 * Theme Tokens - Centralized Color and Design System
 * 
 * REF: THEME/REFACTOR: Centralized theme tokens to replace all hardcoded colors
 * across the application. Provides single source of truth for light/dark themes.
 * 
 * @module constants/themeTokens
 */

// REF: THEME/REFACTOR: Moved from theme/themeTokens.js to constants/ for better organization
 ...
 * REF: THEME/REFACTOR: Helper to convert theme tokens to CSS custom properties
 * 
 * @param {string} theme - 'light' or 'dark'
 * @returns {Object<string, string>} CSS variables object with --theme-* properties
 */
export const getCSSVariables = (theme) => {
  ...
  return {
    ...
    // Chart colors
    '--theme-chart-primary': tokens.chartPrimary,
    '--theme-chart-secondary': tokens.chartSecondary,
    '--theme-chart-accent': tokens.chartAccent,
    '--theme-chart-success': tokens.chartSuccess,
    '--theme-chart-warning': tokens.chartWarning,
    '--theme-chart-error': tokens.chartError,
    '--theme-chart-info': tokens.chartInfo,
  };
};

/**
 * Get a theme token value by key
 * REF: THEME/REFACTOR: Utility to access theme tokens programmatically
 * 
 * @param {string} theme - 'light' or 'dark'
 * @param {string} key - Token key (e.g., 'primary', 'text', 'success')
 * @returns {string|undefined} Token value or undefined if not found
 */
export const getThemeToken = (theme, key) => {
