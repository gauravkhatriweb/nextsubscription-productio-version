    ...
    <div className='relative min-h-screen w-full bg-[#000000] text-white overflow-hidden'>
      ...
      <main className='relative z-10 mx-auto max-w-4xl px-6 py-12 sm:py-16'>
        <header className='mb-6 sm:mb-8'>
          ...
          <p className='mt-2 text-sm text-gray-300' style={{ fontFamily: 'Inter, system-ui' }}>Get in touch with Next Subscription – We're here to help!</p>
        </header>
        ...
        <article className='prose prose-invert max-w-none'>
          <section className='rounded-2xl border border-white/10 bg-white/5 p-5 sm:p-7 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.35)]'>
            <div className='space-y-8'>
              {/* Welcome Message */}
              <div>
                <h2 className='text-xl font-semibold mb-3 text-[#E43636]' style={{ fontFamily: 'Poppins, Inter, system-ui' }}>We're Here to Help</h2>
              ...
              {/* Contact Information */}
              <div>
                <h2 className='text-lg font-semibold mb-4 text-[#F6EFD2]' style={{ fontFamily: 'Poppins, Inter, system-ui' }}>Contact Information</h2>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  {/* Email Support */}
                  <div className='flex items-start gap-4 p-4 rounded-xl border border-white/10 bg-white/5'>
                    <div className='flex-shrink-0 w-12 h-12 rounded-full bg-[#E43636]/20 flex items-center justify-center'>
                      <svg className='w-6 h-6 text-[#E43636]' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    ...
                    <div>
                      ...
                      <a href='mailto:customersupport@nextsubscription.com' className='text-[#E43636] hover:text-[#F6EFD2] text-sm font-medium transition-colors'>
                  ...
                  {/* Phone Support */}
                  <div className='flex items-start gap-4 p-4 rounded-xl border border-white/10 bg-white/5'>
                    <div className='flex-shrink-0 w-12 h-12 rounded-full bg-[#E2DDB4]/20 flex items-center justify-center'>
                      <svg className='w-6 h-6 text-[#E2DDB4]' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    ...
                    <div>
                      ...
                      <a href='tel:+922112345678' className='text-[#E2DDB4] hover:text-[#E43636] text-sm font-medium transition-colors'>
                        +92-21-12345678
                      </a>
                    </div>
                  </div>
                  ...
                  <div className='flex items-start gap-4 p-4 rounded-xl border border-white/10 bg-white/5 md:col-span-2'>
                    <div className='flex-shrink-0 w-12 h-12 rounded-full bg-[#F6EFD2]/20 flex items-center justify-center'>
                      <svg className='w-6 h-6 text-[#F6EFD2]' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                    ...
                    <div>
                      ...
                      <p className='text-[#F6EFD2] text-sm font-medium'>
              ...
              {/* Business Hours */}
              <div>
                <h2 className='text-lg font-semibold mb-4 text-[#E2DDB4]' style={{ fontFamily: 'Poppins, Inter, system-ui' }}>Business Hours</h2>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div className='p-4 rounded-xl border border-white/10 bg-white/5'>
                    <h3 className='font-semibold text-white mb-2' style={{ fontFamily: 'Inter, system-ui' }}>User Support</h3>
              ...
              <div>
                <h2 className='text-lg font-semibold mb-4 text-[#F6EFD2]' style={{ fontFamily: 'Poppins, Inter, system-ui' }}>Quick Support</h2>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4'>
                  <div className='text-center p-4 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors'>
                    <Link to='/legal/faq' className='block'>
                      <div className='w-8 h-8 mx-auto mb-2 text-[#E43636]'>
                  ...
                  <div className='text-center p-4 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors'>
                    <div className='w-8 h-8 mx-auto mb-2 text-[#E2DDB4]'>
                      <svg fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  ...
                  <div className='text-center p-4 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition-colors'>
                    <div className='w-8 h-8 mx-auto mb-2 text-[#F6EFD2]'>
                      <svg fill='none' stroke='currentColor' viewBox='0 0 24 24'>
